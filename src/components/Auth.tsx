...
const Auth: React.FC = () => {
    ...
    return (
        ...
        <>
            ...
            <Modal className={'modal'} open={isModalOpen} onOk={handleOk} onCancel={handleCancel} footer={false} width={'100vw'}>
                <Container>
                    ...
                    <AuthSide>
                        ...
                        <div><h2>Sign In To Eatly</h2></div>
                    ...
                    <ImageSide>
                        ...
                        <div className={'description'}>
                            ...
                            <h3>Eatly Is The Food Delivery Dashboard And Having More Than 2K+ Dishes Including Asian,
                                Chinese, Italians And Many More. Our Dashboard Helps You To Manage Orders And
                                Money.</h3>
                        </div>
